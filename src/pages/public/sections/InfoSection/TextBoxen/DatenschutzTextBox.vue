<template>
  <TextBox
      ...
      v-bind:width-open="this.smallScreen ? '90vw' : '65vw'"
      v-bind:z-base="1"
  ...
  >
    ...
    <p>mail ( at ) hold-hands.net
      <br>Hold Hands Residenz
      <br>c/o Lissy Willberg
      <br>Herbartstr. 75
      <br>04318 Leipzig</p>
    ...
    <p>Empfänger:innen der Daten sind ggf. Auftragsverarbeiter.</p>
    <p></p><h3>Speicherdauer:</h3>
