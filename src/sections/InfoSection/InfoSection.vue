<template>
  <div id="Info-Section">
    ...
    <VideoCutOut
        ...
        v-bind:container-height="'30vw'"
        v-bind:container-left="'170vw'"
        v-bind:container-top="'13vh'"
        v-bind:container-width="'79vw'"
